...
class PpatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request,[
            'no_urut' => 'required|min:2',
            'no_akta' => 'required|min:2',
            'tanggal_akta' => 'required',
            'bentuk_hukum' =>'required|min:2',
            'pihak1' => 'required|min:2',
            'pihak2' => 'required|min:2',
            'nomor_hak' => 'required|min:2',
            'letak_bangunan' => 'required|min:2',
            'luas_tanah' => 'required|min:2',
            'luas_bangunan' => 'required|min:2',
            'harga_transaksi' => 'required|min:2',
            'nop_tahun' =>'required|min:2',
            'nilai_njop' => 'required|min:2',
            'tanggal_ssp' => 'required',
            'nilai_ssp' => 'required|min:2',
            'tanggal_ssb' => 'required',
            'nilai_ssb' => 'required|min:2',
            'keterangan' =>'required|min:2',
            'tgl_masuk_bpn' => 'required',
            'tgl_selesai_bpn' => 'required',
            'tgl_penyerahan_clien' => 'required',
            'no_ktp' => 'required|min:2',
            ...
            'no_urut.min'=>'No Urut minimal 2 character',
            'no_akta.min'=>'No Akta minimal 2 character',
            'bentuk_hukum.min'=>'Bentuk Perbuatan Hukum minimal 2 character',
            'pihak1.min'=>'Pihak Yang Memberikan minimal 2 character',
            'pihak2.min'=>'Pihak Yang Menerima minimal 2 character',
            'nomor_hak.min'=>'Nomor Hak minimal 2 character',
            'letak_bangunan.min'=>'Letak Tanah Dan Bangunan minimal 2 character',
            'luas_tanah.min'=>'Luas Tanah minimal 2 character',
            'luas_bangunan.min'=>'Luas Bangunan minimal 2 character',
            'harga_transaksi.min'=>'Harga Transaksi minimal 2 character',
            'nop_tahun.min'=>'NOP/Tahun minimal 2 character',
            'nilai_njop.min'=>'Nilai NJOP minimal 2 character',
            'nilai_ssp.min'=>'Nilai SSP minimal 2 character',
            'nilai_ssb.min'=>'Nilai SSB minimal 2 character',
            'keterangan.min'=>'Keterangan minimal 2 character',
            'no_ktp.min'=>'No KTP minimal 2 character',
            'alamat.min'=>'Alamat minimal 2 character',
